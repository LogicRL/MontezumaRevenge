...
from RLAgents.ImitationLearningAgents import RLAgents
...
class AutoAgentImitation(AutoAgent):
  """
  Imitation learning AutoAgent class.
  """

  def __init__(self, env, decoder, fname_domain, fname_problem, static_predicate_operators):
    super(AutoAgentImitation, self).__init__(env, decoder, fname_domain, fname_problem, static_predicate_operators)
...
def main():
  ...
  agent = AutoAgentImitation(env, decoder, fname_domain, fname_problem, static_predicate_operators)
